    ...
    return (
      <div style={{ padding: '60px', textAlign: 'center', backgroundColor: '#f8fafc', minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ background: '#fff', padding: '40px', borderRadius: '16px', border: '1px solid #e2e8f0', maxWidth: '500px', boxShadow: '0 10px 25px rgba(0,0,0,0.05)' }}>
          ...
          <button onClick={() => navigate('/planos')} style={{ background: '#0f172a', color: '#fff', padding: '12px 24px', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer', border: 'none' }}>Fazer Upgrade Agora</button>
        </div>
      </div>
    );
  }
    ...
    <div className="estoque-premium">
      <div className="header-top">
        <div className="titulo-bloco">
          ...
          <p>
            Gerencie o acesso e a jornada da sua equipe. <strong style={{ color: (equipe.length + 1) >= limiteUsuarios ? '#ef4444' : '#10b981' }}>
        ...
        <div className="acoes-top" style={{ display: 'flex', gap: '15px' }}>
          <button 
            ...
            style={{ background: '#f8fafc', color: '#0f172a', border: '1px solid #cbd5e1', padding: '0 20px', borderRadius: '8px', fontWeight: 'bold', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', transition: 'all 0.2s' }}
          >
        ...
        <table className="table-pro" style={{ width: '100%', borderCollapse: 'collapse', backgroundColor: '#fff', borderRadius: '8px' }}>
          ...
          <tbody>
            <tr style={{ borderBottom: '1px solid #f1f5f9', background: '#f8fafc' }}>
              ...
              <td style={{ padding: '15px', fontSize: '13px', color: '#334155', fontWeight: 'bold' }}>Administração Geral</td>
              <td style={{ padding: '15px', color: '#10b981', fontWeight: 'bold', fontSize: '12px' }}>Acesso Total + Financeiro</td>
            ...
            {equipe.map(membro => {
              ...
              <tr key={membro.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                ...
                <td style={{ padding: '15px', fontSize: '13px', color: '#475569' }}>
                    ...
                    {membro.monitorarAtividade && <span style={{ display: 'block', fontSize: '10px', color: '#10b981', marginTop: '4px' }}><i className="fas fa-desktop"></i> Atividades Monitoradas</span>}
                </td>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }}>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', gap: '15px', marginBottom: '15px' }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <input type="text" placeholder="(00) 00000-0000" value={novoUsuario.telefone} onChange={e => setNovoUsuario({...novoUsuario, telefone: e.target.value})} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid #cbd5e1', boxSizing: 'border-box' }} />
                    </div>
                  </div>
                  ...
                  <div style={{ marginBottom: '15px' }}>
                    ...
                    <input required type="email" placeholder="joao@suaempresa.com" value={novoUsuario.email} onChange={e => setNovoUsuario({...novoUsuario, email: e.target.value})} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid #cbd5e1', boxSizing: 'border-box' }} />
                  </div>
                ...
                <div>
                  ...
                  <div style={{ marginBottom: '15px' }}>
                    ...
                    <input type="text" placeholder="Ex: Vendedor, Estoquista, Gerente..." value={novoUsuario.cargo} onChange={e => setNovoUsuario({...novoUsuario, cargo: e.target.value})} style={{ width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid #cbd5e1', boxSizing: 'border-box' }} />
                  </div>

                  <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '15px', marginBottom: '25px' }}>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' }}>
                      <input type="checkbox" checked={novoUsuario.monitorarAtividade} onChange={e => setNovoUsuario({...novoUsuario, monitorarAtividade: e.target.checked})} style={{ width: '18px', height: '18px', accentColor: '#0f172a' }} />
              ...
              <div style={{ marginTop: '10px', borderTop: '1px solid #e2e8f0', paddingTop: '20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', background: '#fef2f2', padding: '10px 15px', borderRadius: '8px', width: '60%' }}>
                  ...
                  <p style={{ margin: 0, fontSize: '11px', color: '#b91c1c', lineHeight: '1.4' }}>
                    <strong>Acesso Restrito:</strong> Financeiro, Relatórios e Configurações da Empresa são bloqueados automaticamente para proteger seus dados sigilosos.
                  </p>
                </div>
